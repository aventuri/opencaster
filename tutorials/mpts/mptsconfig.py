...
avalpa1_service_id = 1 
avalpa2_service_id = 2 
avalpa3_service_id = 3 
avalpa1_pmt_pid = 1031
avalpa2_pmt_pid = 1032
avalpa3_pmt_pid = 1033
	...
	transport_stream_loop = [
		...
		transport_descriptor_loop = [
			...
			dvb_service_descriptor_loop = [
			    ...
			    service_descriptor_loop_item(
				service_ID = avalpa2_service_id, 
				service_type = 1, # digital tv service type
			    ),
			    service_descriptor_loop_item(
				service_ID = avalpa3_service_id, 
				service_type = 1, # digital tv service type
			    ),
			],
		    ),
...
pat = program_association_section(
	transport_stream_id = avalpa_transport_stream_id,
	    ...
	    program_loop_item(
	        program_number = avalpa2_service_id,
    		PID = avalpa2_pmt_pid,
    	    ),  
    	    program_loop_item(
	        program_number = avalpa3_service_id,
    		PID = avalpa3_pmt_pid,
    	    ),  
    	    program_loop_item(
